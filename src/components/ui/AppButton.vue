...
const base =
  "inline-flex rounded-full text-medium items-center justify-center gap-2 transition-colors whitespace-nowrap disabled:opacity-60 disabled:cursor-not-allowed";

const variants = {
  primary: "bg-primary-500 hover:bg-primary-600 text-white",
  secondary:
    "border border-white/25 bg-white/25 text-white backdrop-blur-lg hover:border-white/50 hover:bg-white/30",
  glass:
    "border border-white/25 bg-white/25 text-white backdrop-blur-lg hover:border-white/50 hover:bg-white/30",
};
